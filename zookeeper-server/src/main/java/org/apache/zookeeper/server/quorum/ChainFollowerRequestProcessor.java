 ...
 */
public class ChainFollowerRequestProcessor extends ZooKeeperCriticalThread implements RequestProcessor {

    private static final Logger LOG = LoggerFactory.getLogger(ChainFollowerRequestProcessor.class);
     ...
     * @param nextProcessor
     */
    public ChainFollowerRequestProcessor(ChainZookeeperServer zks, RequestProcessor nextProcessor) {
