...
public class ZooChainProto extends GenericProtocol {

    public final static short PROTOCOL_ID = 200;
    public final static String PROTOCOL_NAME = "ZooChainProto";
    ...
    private static final Logger logger = LoggerFactory.getLogger(ZooChainProto.class);
    ...
    public ZooChainProto(Properties props, EventLoopGroup workerGroup, ZooChainFront frontend) throws UnknownHostException {
