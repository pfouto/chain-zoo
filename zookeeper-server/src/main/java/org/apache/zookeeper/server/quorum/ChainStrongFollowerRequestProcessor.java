 ...
 */
public class ChainStrongFollowerRequestProcessor extends ZooKeeperCriticalThread implements RequestProcessor {

    private static final Logger LOG = LoggerFactory.getLogger(ChainStrongFollowerRequestProcessor.class);
     ...
     * @param nextProcessor
     */
    public ChainStrongFollowerRequestProcessor(ChainZookeeperServer zks, RequestProcessor nextProcessor) {
